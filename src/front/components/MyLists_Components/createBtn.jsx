                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="createBtnModalLabel">New List</h5>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-outline-dark fs-5" data-bs-dismiss="modal">Close</button>
                            <button type="button" className="btn btn-success fs-5">Create</button>
                        </div>
                    </div>
                </div>
            </div>
